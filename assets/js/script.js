...
$(document).ready(function () {
  $(".category .items li.all").click(function (e) {
    e.preventDefault();
    $(".players-images .player").fadeIn();
  });
});
$(document).ready(function () {
  $(".category .items li.forwards").click(function (e) {
    e.preventDefault();
    midfielders.fadeOut();
    defenders.fadeOut();
    goalkeepers.fadeOut();
...
$(document).ready(function () {
  $(".category .items li.midfielders").click(function (e) {
    e.preventDefault();
    forwards.fadeOut();
    defenders.fadeOut();
    goalkeepers.fadeOut();
...
$(document).ready(function () {
  $(".category .items li.defenders").click(function (e) {
    e.preventDefault();
    forwards.fadeOut();
    midfielders.fadeOut();
    goalkeepers.fadeOut();
...
$(document).ready(function () {
  $(".category .items li.goalkeepers").click(function (e) {
    e.preventDefault();
    midfielders.fadeOut();
    defenders.fadeOut();
    forwards.fadeOut();
